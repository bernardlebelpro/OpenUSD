...
//
#ifndef PXR_BASE_GF_BLUNDA_CAMERA_H
#define PXR_BASE_GF_BLUNDA_CAMERA_H
...
public:
    ...
    GF_API void SetHohoho(const float val);
...
#endif // PXR_BASE_GF_BLUNDA_CAMERA_H
